...
<html>
	...
	<body>
		...
		<div class="wrapper" style="background-image: url('public/images/bg-registration-form-1.jpg');">
			<div class="inner">
				<div class="image-holder">
					<img src="public/images/registration-form-1.jpg" alt="">
				</div>
				<form action="">
					...
					<div class="form-wrapper">
						<input type="text" placeholder="Direccion Email" class="form-control">
					...
					<div class="form-wrapper">
						<select name="" id="" class="form-control">
							...
							<option value="femal">Femenino</option>
